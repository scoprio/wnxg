...
import com.ulb.web.demo.EventTypeEnum;
import com.ulb.web.demo.OApiException;
import com.ulb.web.demo.auth.AuthHelper;
import com.ulb.web.demo.service.ServiceHelper;
import com.ulb.web.utils.FileUtils;
import com.ulb.web.utils.aes.DingTalkEncryptException;
import com.ulb.web.utils.aes.DingTalkEncryptor;
...
public class DDResource {
    ...
    public Object callBack(HttpServletRequest request, HttpServletResponse response) throws Exception{
		 ...
		 */
        Integer id = EventTypeEnum.getIdByCode(eventType);
        String res = "success";
        switch (id) {
            case 1:
