...
import com.ulb.web.demo.utils.aes.DingTalkEncryptException;
import com.ulb.web.demo.utils.aes.DingTalkEncryptor;
    ...
    public void callBack(HttpServletRequest request, HttpServletResponse response) throws Exception {
        try {
            ...
            switch (eventType) {
				 ...
				 */
                    logger.info("重要信息  suite_ticket:"+plainTextJson.getString("SuiteTicket"));
